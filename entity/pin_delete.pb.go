...
func init() {
	proto.RegisterType((*DeleteRequest)(nil), "entity.DeleteRequest")
	proto.RegisterType((*PinDeleteResponse)(nil), "entity.PinDeleteResponse")
}
...
func (c *deletePinClient) Execute(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*PinDeleteResponse, error) {
	...
	err := grpc.Invoke(ctx, "/entity.DeletePin/Execute", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DeletePin_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/entity.DeletePin/Execute",
	}
...
var fileDescriptor1 = []byte{
	...
	0x4f, 0x49, 0xcd, 0x49, 0x2d, 0x49, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x4b, 0xcd,
	0x2b, 0xc9, 0x2c, 0xa9, 0x54, 0x92, 0xe7, 0xe2, 0x75, 0x01, 0x8b, 0x07, 0xa5, 0x16, 0x96, 0xa6,
	0x16, 0x97, 0x08, 0xf1, 0x71, 0x31, 0x65, 0xa6, 0x48, 0x30, 0x2a, 0x30, 0x6a, 0xb0, 0x06, 0x31,
	0x65, 0xa6, 0x28, 0x09, 0x73, 0x09, 0x06, 0x64, 0xe6, 0xc1, 0xd4, 0x14, 0x17, 0xe4, 0xe7, 0x15,
	0xa7, 0x1a, 0x79, 0x71, 0x71, 0x42, 0x44, 0x02, 0x32, 0xf3, 0x84, 0x6c, 0xb9, 0xd8, 0x5d, 0x2b,
	0x52, 0x93, 0x4b, 0x4b, 0x52, 0x85, 0x44, 0xf5, 0x20, 0xc6, 0xea, 0xa1, 0x98, 0x29, 0x25, 0x09,
	0x13, 0xc6, 0x30, 0x49, 0x89, 0x21, 0x89, 0x0d, 0xec, 0x20, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x1e, 0xa1, 0xaf, 0xea, 0xa4, 0x00, 0x00, 0x00,
}
